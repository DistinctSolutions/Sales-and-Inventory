Public Class frmMain
    ...
    Private Sub PointOfSaleToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ToolStripButton9_Click(sender As Object, e As EventArgs) Handles ToolStripButton9.Click
        MessageBox.Show("Thank you for using this system", "Rinmed Chemist", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Me.Close()
    ...
    Private Sub CreateASaleToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CreateASaleToolStripMenuItem.Click
        frmPOS.Show()
    End Sub
End Class
